...
export default [
  {
    answer:
      "<p>Pour devenir psychologue partenaire du dispositif Mon soutien psy, il est nécessaire de : <ul><li>Etre inscrit sur le registre ADELI attestant du titre de psychologue;</li><li>Disposer d’une expérience professionnelle en psychologie clinique ou en psychopathologie de trois ans minimum ;</li><li>Avoir une expérience ou un diplôme permettant d’attester d’un parcours consolidé en psychologie clinique ou en psychopathologie.</li></ul></p><p>Ces critères ont été définis en accord avec les représentants des psychologues.</p>",
    question: "Quelles sont les conditions de participation au dispositif ?",
  },
  {
    answer:
      "<p>Les psychothérapeutes agréés par les ARS ou les psychanalystes ne sont pas éligibles au dispositif Mon soutien psy.</p>",
    question:
      "Faut-il nécessairement être psychologue ? Qu’en est-il des psychothérapeutes agréés par les ARS ?",
  },
  {
    answer:
      "<p>Le numéro ADELI est obligatoire, car il permet d’attester que son détenteur est autorisé à faire usage du titre de psychologue. Le numéro SIRET n’offre pas une telle garantie. Les démarches pour obtenir le numéro ADELI doivent être réalisées auprès de l’ARS de son lieu d’exercice.</p><p>Le numéro ADELI commence par le numéro de département de votre exercice principal. Si tel n’est pas le cas, rapprochez-vous de votre ARS pour obtenir un numéro ADELI correspondant.</p>",
    question:
      "Je ne dispose pas de numéro Adeli mais d’un numéro Siret. Puis-je participer au dispositif ?",
  },
  {
    answer:
  ...
  },
  {
    answer:
      ...
      "</ul>",
    question:
      "Les psychologues salariés peuvent-ils participer au dispositif Mon soutien psy ?",
  },
  {
    answer:
      "<p>Oui, un psychologue participant déjà à un autre dispositif (ex : la mesure 31 du Ségur de la Santé « renforcement en psychologues des MSP ») peut tout à fait devenir partenaire du dispositif Mon soutien psy.</p>" +
      "<p>Dans ce cas, le psychologue devra distinguer :</p>" +
      "<ul><li>Les patients suivis dans le cadre de Mon soutien psy dont les séances feront l’objet d’un remboursement direct par la CPAM</li>" +
    ...
    question:
      "Un psychologue participant à des dispositifs pré-existants (ex : mesure 31 du Ségur de la Santé) peut-il être partenaire dans le cadre de Mon soutien psy ?",
  },
  {
    answer:
