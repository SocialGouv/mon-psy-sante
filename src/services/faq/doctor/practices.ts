...
export default [
  {
    answer:
      "<p>Non, l’utilisation d’échelles et de scores n’est pas obligatoire.</p><p>Cette utilisation est recommandée notamment en cas de doute sur l’intensité de la souffrance psychique de votre patient.</p><p>Elle vous permet par ailleurs d’échanger avec le psychologue sur des éléments partagés.</p>",
    question:
      "L’utilisation des échelles d’évaluation de l’intensité des symptômes anxieux ou dépressifs est-elle obligatoire ?",
  },
  {
    answer:
