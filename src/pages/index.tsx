...
const Page = () => {
  ...
  return (
    <>
      <HeadTag
        title="MonSoutienPsy : Le dispositif de remboursement des séances chez le psychologue | Ministère de la Santé"
        description="MonSoutienPsy est un dispositif du Ministère de la Santé permettant à chacun de bénéficier de séances remboursées avec un psychologue conventionné avec l’Assurance Maladie."
            ...
            <div className="fr-col-12 fr-col-md-6 fr-pt-4w">
              <h1>
                ...
                <span className="fr-text--lead d-block fr-mt-3w">
                  Avec MonSoutienPsy, bénéficiez de 8 séances par an chez un ou
                  une psychologue
                </span>
              </h1>
        ...
        <div className="fr-container--fluid fr-bg--light fr-py-10w">
          <div className="fr-container">
            <div className="fr-grid-row fr-grid-row--gutters fr-grid-row--middle">
              ...
              <div className="fr-col-12 fr-col-md-6">
                <h2 className="fr-h5">MonSoutienPsy c’est&nbsp;:</h2>
                <ul className="no-bullet list-blue-france-arrow">
                  <li className="fr-li--icon-left fr-fi-arrow-right-line">
                    &nbsp;Un annuaire de{" "}
                  ...
                  <div className="fr-card__body">
                    <div className="fr-card__content">
                      ...
                      <p className="fr-card__desc fr-text--md">
                        ...
                        MonSoutienPsy est adapté à votre situation. Vous pouvez
        ...
        <div className="fr-container fr-py-10w">
          <div className="fr-grid-row fr-grid-row--center fr-index-box">
            <div className="fr-col-12 fr-col-md-8 fr-pt-4w">
              <h2>MonSoutienPsy pour les moins de 18 ans</h2>
              <ul className="no-bullet list-brown-cafe-creme-main-arrow">
                <li className="fr-li--icon-left fr-fi-check-line">
